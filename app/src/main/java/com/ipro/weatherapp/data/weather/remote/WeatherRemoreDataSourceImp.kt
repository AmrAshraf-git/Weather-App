    ...
    : WeatherDto {
        val response = client.get(BASE_WEATHER_URL){
            url {
                ...
                parameters.append("current", "temperature_2m,weather_code,wind_speed_10m,relative_humidity_2m,precipitation_probability,uv_index,surface_pressure,apparent_temperature")
                parameters.append("hourly", "temperature_2m,weather_code,time")
                parameters.append("daily", "temperature_2m_max,temperature_2m_min,weather_code,time")
